...
export default function SerialHome(props) {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      alert("นำข้อมูลออกไปเรียบร้อยแล้ว");
    } catch (error) {
  ...
  return (
    ...
    <button className="btn bg-dark-400 hover:bg-dark-600 text-white border-none btn-info pl-4 pr-4 mt-2">
      Back
    </button>
  </Link>
    ...
    <div className="mr-5">
      ...
      >
        <button className="btn bg-red-500 hover:bg-green-600 border-none text-white btn-info pl-16 pr-16 mt-2">
          เพิ่มข้อมูลรีวิว
        </button>
      </Link>
    </div>
