...
export default function ProductCard(props) {
  ...
  return (
    <div
      className="bg-white shadow-2xl mx-auto ml-5 cursor-pointer rounded-lg p-3 hover:shadow-md transition duration-300"
    ...
    >
      ...
      <h2 className="bg-green-600 pr-10 pl-10 rounded-xl text-black flex justify-center items-center text-3xl font-bold mb-4 h-12 overflow-hidden whitespace-nowrap">{el.name.length > 16 ? el.name.slice(0, 16) + '...' : el.name}</h2>
